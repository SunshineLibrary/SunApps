...
import static com.sunshine.metadata.provider.MetadataContract.Packages;
...
public class PackageHelper {
    ...
    private static List<com.sunshine.support.data.models.Package> getPackageListFromCursor(Cursor cursor) {
        List<Package> packages = new Vector<Package>();
