...
public class BookCollectionInfoView implements TableView {
    ...
    private String createViewQuery() {
        ...
        query.append(String.format(" where %s.%s=%s.%s) as %s",
        		 BookTable.TABLE_NAME, Books._COLLECTION_ID, BookCollectionTable.TABLE_NAME, BookCollections._ID, BookCollectionInfo._COUNT
        		));
        ...
        query.append(String.format(", group_concat(distinct %s.%s) as %s", TagTable.TABLE_NAME, Tags._NAME, BookCollectionInfo._TAGS));
        ...
        query.append(String.format(" where %s>0", BookCollectionInfo._COUNT));
        query.append(String.format(" group by %s.%s ", BookCollectionTable.TABLE_NAME, BookCollections._ID));
