...
public final class FBReaderApp extends ZLApplication {
	...
	public final ZLIntegerRangeOption BottomMarginOption;
	{
		...
		LeftMarginOption = new ZLIntegerRangeOption("Options", "LeftMargin", 0, 100, 64);
		RightMarginOption = new ZLIntegerRangeOption("Options", "RightMargin", 0, 100, 64);
		TopMarginOption = new ZLIntegerRangeOption("Options", "TopMargin", 0, 200, 100);
		BottomMarginOption = new ZLIntegerRangeOption("Options", "BottomMargin", 0, 100, 57);
	}
	...
	public final ZLIntegerRangeOption FooterHeightOption =
		new ZLIntegerRangeOption("Options", "FooterHeight", 8, 30, 28);
	...
	public synchronized void updateAllBookmarksList(Bookmark b) {
		if (Model != null && Model.Book != null && b != null) {
			for (Bookmark bm : Library.Instance().allBookmarks()) {
				if (b.equals(bm)) {
					bm.delete();
				}
			}
