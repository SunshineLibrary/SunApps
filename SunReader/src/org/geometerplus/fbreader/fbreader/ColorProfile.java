...
public class ColorProfile {
	...
	public final ZLColorOption FooterTextOption;
	...
	private ColorProfile(String name, ColorProfile base) {
		...
		FooterTextOption.setValue(base.FooterTextOption.getValue());
	}
	...
	private ColorProfile(String name) {
		if (NIGHT.equals(name)) {
			...
			BackgroundOption =
				createOption(name, "Background", 125, 125, 125);  //0,0,0 qiumin
			...
			FooterTextOption =
				 createOption(name, "FooterTextOption", 143,145,145);	
		} else {
			WallpaperOption =
				new ZLStringOption("Colors", name + ":Wallpaper", "");//wallpapers/sepia.jpg
			BackgroundOption =
				createOption(name, "Background", 237, 237, 237);//255,255,255
			SelectionBackgroundOption =
				createOption(name, "SelectionBackground", 82, 131, 194);
			SelectionForegroundOption =
				createOption(name, "SelectionForeground", 255, 255, 220);
