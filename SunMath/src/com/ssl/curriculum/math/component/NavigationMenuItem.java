...
public class NavigationMenuItem extends FrameLayout {
	...
	private void initUI() {
		...
		ViewGroup viewGroup = (ViewGroup) inflater.inflate(
				R.layout.navigation_item, this, false);
		...
		setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				if (nextLevelChangedListener != null) {
					nextLevelChangedListener.onNextLevelMenu(menuItemLabel
							.getText().toString());
				}
			}
		});
	...
	public void setNextLevelChangedListener(
			NextLevelMenuChangedListener nextLevelChangedListener) {
		this.nextLevelChangedListener = nextLevelChangedListener;
	}

	public void active() {
		bgImageView.setImageDrawable(getResources().getDrawable(
				R.drawable.ic_side_list_selected));
	}

	public void deActive() {
		bgImageView.setImageDrawable(getResources().getDrawable(
				R.drawable.ic_side_list_not_selected));
	}
}
